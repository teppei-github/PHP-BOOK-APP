<?php
$dsn = 'mysql:dbname=lesson;host=localhost;charset=utf8mb4';
$user = 'root';
$password = 'root';
        ...
        <article class="registration">
            ...
            <form action="update.php?id=<?= $_GET['id'] ?>" method="post" class="registration-form">
                <div>
                    ...
                    <input type="text" id="book_name" name="book_name" value="<?= $product['book_name'] ?>"
                    ...
                    <input type="number" id="stock_quantity" name="stock_quantity"
                        value="<?= $product['stock_quantity'] ?>" min="0" max="100000000" required>
